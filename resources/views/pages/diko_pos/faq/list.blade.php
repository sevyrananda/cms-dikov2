...
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-left">
                                    ...
                                    <a href="{{ route('pos.previewall') }}"  class="btn btn-success"><i class="fas fa-eye"></i>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content">
                                                            <a href="{{ route('pos.preview', ['id' => $post->id]) }}" class="btn btn-primary">Preview</a>
                                                            ...
                                                            <form id="delete-form-{{ $post->id }}"
                                                                action="{{ route('pos.destroy', ['id' => $post->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
    ...
    <!-- Create Post Modal -->
    @include('pages.diko_pos.faq.modals.create_modal')
    @include('pages.diko_pos.faq.modals.edit_modal')
@endsection
